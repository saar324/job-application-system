...
const serverKeys = [
  "HOST", "PORT", "JOB_SERVER_CONFIG", "JOB_SERVER_DATA", "JOB_SERVER_PROFILES_FILE",
...
const workerKeys = [
  ...
  "WORKER_ARTIFACTS", "WORKER_DOCUMENT_ROOT", "WORKER_RECEIPTS", "WORKER_HEADLESS", "PLAYWRIGHT_BROWSERS_PATH"
];
