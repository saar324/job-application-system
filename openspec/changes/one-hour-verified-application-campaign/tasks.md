Checked boxes mean completed in the repository; they do not claim a production throughput result. Applicant-specific
rollout evidence belongs in private operational records.
