...
| P0 | Roll out the 23 September cross-source duplicate correction to production. | The isolated branch indexes employer receipt URLs and matches listing/application ATS variants; 218 tests and privacy check pass. Live staging lookups for RapidSOS, Wayflyer, and n8n returned their original submitted applications without queuing new work. |
...
30-second acceptance target remains unmet.
